  ...
  (function (window) {
    ...
    function initWidget(widgetEl) {
      ...
      if ((widgetId = widgetEl.getAttribute("data-telegram-post"))) {
        ...
        widgetElId = "telegram-post-" + widgetId.replace(/[^a-z0-9_]/gi, "-");
    ...
    if (!document.currentScript || !initWidget(document.currentScript)) {
      ...
      if (document.querySelectorAll) {
        widgets = document.querySelectorAll(
          "script[data-telegram-post],blockquote.telegram-post,script[data-telegram-login],script[data-telegram-share-url]"
        );
      } else {
      ...
      auth: function (options, callback) {
        ...
        var checkClose = function (bot_id) {
          ...
          if (
            ...
            return TelegramLogin.getAuthData(options, function (
              origin,
              authData
            ) {
              onAuthDone(authData);
